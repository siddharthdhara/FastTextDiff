...
def enable_flash_attention(model):
    ...
    for layer in model.encoder.layer:
        layer.attention.self.forward = lambda x: flash_attn_qkvpacked_func(x, causal=False)
...
class Mixdataset(Dataset):
    def __init__(self, dataset_path: str, row_text: str, joint_transform: Callable = None,
        ...
        # self.tokenizer = AutoTokenizer.from_pretrained('siddharthdhara17/ClinicalModernBERT-3ep', use_auth_token=True,use_flash_attention=True)
        # self.tokenizer =  AutoTokenizer.from_pretrained('emilyalsentzer/Bio_ClinicalBERT')
        #self.tokenizer =  AutoTokenizer.from_pretrained('answerdotai/ModernBERT-base')
        # self.tokenizer = AutoTokenizer.from_pretrained('siddharthdhara17/ModernClinicalBERT-4', use_auth_token=True)
        # self.bert_embedding = AutoModel.from_pretrained('siddharthdhara17/ClinicalModernBERT-3ep', use_auth_token=True,use_flash_attention=True)
        ...
        # self.bert_embedding = AutoModel.from_pretrained('siddharthdhara17/ModernClinicalBERT-4', use_auth_token=True)
